...
const deleteCommentByCommentId = (req, res) => {
  ...
  const getCommentByProductId = (req, res) => {
    ...
    const sql = "SELECT comments.*, Users.username , Users.profile_picture FROM comments LEFT JOIN Users ON Users.id = comments.user_id LEFT JOIN Products ON Products.id = comments.product_id WHERE comments.product_id = ?; "
...
module.exports= {getCommentByProductId,updateProductById,addComment , deleteCommentByCommentId}
